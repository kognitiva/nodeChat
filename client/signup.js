...
/* Adding features
* a custom jQuery-type selector CHECK
* a function to establish a connection to the server CHECK 
* an event listener for the submit button CHECK
* a join function to submit the data to the server CHECK
* an alert function to receive messages from the server and output them to the user
* a clear function to clear the form after the data is submitted
*/
